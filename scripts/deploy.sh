...
DASH_FULLPATH="$2/$3"
PLUGINNAME="Dashing-SnmpGraph"
REPONAME='dashing-snmpgraph'
DEFAULTUSER='pi'
DEFAULTDASHBOARD='snmpgraph_dashboard'
CONFDIR="${DASH_ROOT}/conf.d"
CONFFILE="snmpgraph-defaults.yaml"
#declare -a WIDGETS=("snmpgraph")
declare -a DASHBOARDS=("snmpgraph.erb")
declare -a JOBS=("snmpgraph.rb")
declare -a CREATE_DIRS=("history")
################################################################################
...
finishUp(){
  ...
  echo -e "\033[1;33mBe sure to restart dashing to pick up the changes.\033[0m" 1>&2
